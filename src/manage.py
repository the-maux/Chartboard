...
def startDjango(settings_path='Chartboard.webserver.settings'):
...
def show_help():
    ...
    Usage:
      ...
      -r, or runserver\t=> start the Chartboard server
...
def main_as_pkg():
    ...
    return startDjango(settings_path='src.Chartboard.webserver.settings')
