...
def sonde9(tester=False, tile_id='bv_ex'):
    ...
    CHARTBOARDAnswer = sendUpdateByApi(tileId=tile_id, data=data, tileTemplate='big_value', tester=tester, meta=meta)
    end(title=f'sensors9 -> {tile_id}', startTime=start_time, CHARTBOARDAnswer=CHARTBOARDAnswer, tileId=tile_id)
