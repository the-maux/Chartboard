...
def sonde10(tester=False, tile_id='jv_ex'):
    ...
    CHARTBOARDAnswer = sendUpdateByApi(tileId=tile_id, data=data, tileTemplate='just_value', meta=meta, tester=tester)
    end(title=f'sensors10 -> {tile_id}', startTime=start_time, CHARTBOARDAnswer=CHARTBOARDAnswer, tileId=tile_id)
